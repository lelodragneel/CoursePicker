...
/**
 * Created by michael on 3/09/2018.
 */

//TODO:Customize this code for scheduling

public class ClassListAdapter extends BaseExpandableListAdapter {
    private Context _context;
    private List<String> _listDataHeader;
    private HashMap<String, Class> _listDataChild;

    protected ClassListAdapter(Context context, List<String> listDataHeader,
                                 HashMap<String, Class> listChildData) {
